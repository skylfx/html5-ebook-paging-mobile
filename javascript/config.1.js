...
;
	...
	bookConfig.FullscreenButtonIcon="files/extfiles/ico-table-edit.png";
	bookConfig.DownloadButtonVisible=true;
	bookConfig.DownloadButtonIcon=="files/extfiles/ico-table-edit.png";
	bookConfig.ToolbarViewMode="pro";
